	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ee:	0f be 80 c8 0f 80 00 	movsbl 0x800fc8(%eax),%eax
  8001f5:	50                   	push   %eax
...
00800242 <vprintfmt>:
{
  ...
  80028e:	ff 24 85 80 10 80 00 	jmp    *0x801080(,%eax,4)
  ...
  80035a:	8b 14 85 e0 11 80 00 	mov    0x8011e0(,%eax,4),%edx
  800361:	85 d2                	test   %edx,%edx
  800363:	74 18                	je     80037d <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800365:	52                   	push   %edx
  800366:	68 e9 0f 80 00       	push   $0x800fe9
  80036b:	53                   	push   %ebx
  80036c:	56                   	push   %esi
  ...
  80037d:	50                   	push   %eax
  80037e:	68 e0 0f 80 00       	push   $0x800fe0
  800383:	53                   	push   %ebx
  800384:	56                   	push   %esi
  ...
  8003a5:	b8 d9 0f 80 00       	mov    $0x800fd9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b0d:	68 04 12 80 00       	push   $0x801204
  800b12:	6a 23                	push   $0x23
  800b14:	68 21 12 80 00       	push   $0x801221
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b8e:	68 04 12 80 00       	push   $0x801204
  800b93:	6a 23                	push   $0x23
  800b95:	68 21 12 80 00       	push   $0x801221
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bd0:	68 04 12 80 00       	push   $0x801204
  800bd5:	6a 23                	push   $0x23
  800bd7:	68 21 12 80 00       	push   $0x801221
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c12:	68 04 12 80 00       	push   $0x801204
  800c17:	6a 23                	push   $0x23
  800c19:	68 21 12 80 00       	push   $0x801221
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c54:	68 04 12 80 00       	push   $0x801204
  800c59:	6a 23                	push   $0x23
  800c5b:	68 21 12 80 00       	push   $0x801221
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c96:	68 04 12 80 00       	push   $0x801204
  800c9b:	6a 23                	push   $0x23
  800c9d:	68 21 12 80 00       	push   $0x801221
...
sys_ipc_recv(void *dstva)
{
  ...
  800cfa:	68 04 12 80 00       	push   $0x801204
  800cff:	6a 23                	push   $0x23
  800d01:	68 21 12 80 00       	push   $0x801221
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d27:	56                   	push   %esi
  800d28:	50                   	push   %eax
  800d29:	68 30 12 80 00       	push   $0x801230
  ...
  800d3a:	e8 b5 f3 ff ff       	call   8000f4 <vcprintf>
	cprintf("\n");
  800d3f:	c7 04 24 bc 0f 80 00 	movl   $0x800fbc,(%esp)
