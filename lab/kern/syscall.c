	     ...
	     envid_t dstenvid, void *dstva, int perm)
{
	...
	if (page_insert_ret) {
		return page_insert_ret;
	}
	return 0;
	//page pnic("sys_page_map not implemented");
}
...
syscall(uint32_t syscallno, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	...
	switch (syscallno) {
		...
		{
			int32_t ret = (int32_t)sys_env_destroy((envid_t)a1);
			return ret;
		}
		case SYS_yield:
		{
		...
		case SYS_exofork:
		{
			int32_t ret = sys_exofork();
			return ret;
		}
		case SYS_page_alloc:
		{
			int32_t ret = sys_page_alloc((envid_t)a1, (void*)a2, a3);
			return ret;
		}
		case SYS_page_map:
		{
			int32_t ret = sys_page_map((envid_t)a1, (void*)a2, (envid_t)a3, (void*)a4, a5);
			return ret;
		}
		case SYS_page_unmap:
		{
			int32_t ret = sys_page_unmap((envid_t)a1, (void*)a2);
			return ret;
		}
		case SYS_env_set_status:
		{
			int32_t ret= sys_env_set_status((envid_t)a1, a2);
			return ret;
