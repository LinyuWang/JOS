...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	68 af 0f 80 00       	push   $0x800faf
  80011e:	6a 23                	push   $0x23
  800120:	68 cc 0f 80 00       	push   $0x800fcc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019a:	68 af 0f 80 00       	push   $0x800faf
  80019f:	6a 23                	push   $0x23
  8001a1:	68 cc 0f 80 00       	push   $0x800fcc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001dc:	68 af 0f 80 00       	push   $0x800faf
  8001e1:	6a 23                	push   $0x23
  8001e3:	68 cc 0f 80 00       	push   $0x800fcc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021e:	68 af 0f 80 00       	push   $0x800faf
  800223:	6a 23                	push   $0x23
  800225:	68 cc 0f 80 00       	push   $0x800fcc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800260:	68 af 0f 80 00       	push   $0x800faf
  800265:	6a 23                	push   $0x23
  800267:	68 cc 0f 80 00       	push   $0x800fcc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002a2:	68 af 0f 80 00       	push   $0x800faf
  8002a7:	6a 23                	push   $0x23
  8002a9:	68 cc 0f 80 00       	push   $0x800fcc
...
sys_ipc_recv(void *dstva)
{
  ...
  800306:	68 af 0f 80 00       	push   $0x800faf
  80030b:	6a 23                	push   $0x23
  80030d:	68 cc 0f 80 00       	push   $0x800fcc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800346:	e8 56 00 00 00       	call   8003a1 <vcprintf>
	cprintf("\n");
  80034b:	c7 04 24 00 10 80 00 	movl   $0x801000,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80049b:	0f be 80 02 10 80 00 	movsbl 0x801002(%eax),%eax
  8004a2:	50                   	push   %eax
...
008004ef <vprintfmt>:
{
  ...
  800612:	52                   	push   %edx
  800613:	68 23 10 80 00       	push   $0x801023
  800618:	53                   	push   %ebx
  800619:	56                   	push   %esi
  ...
  80062a:	50                   	push   %eax
  80062b:	68 1a 10 80 00       	push   $0x80101a
  800630:	53                   	push   %ebx
  800631:	56                   	push   %esi
  ...
  800652:	b8 13 10 80 00       	mov    $0x801013,%eax
